...
from ragdoll.app.models.base_model_ import Model
from ragdoll.app.models.git_log_message import GitLogMessage
...
class ConfBaseInfo(Model):
    ...
    def __init__(self, file_path: str = None, expected_contents: str = None,
                 change_log: List[GitLogMessage] = None):  # noqa: E501
